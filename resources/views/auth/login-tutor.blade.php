        ...
        <div class="max-w-4xl w-full grid grid-cols-1 lg:grid-cols-2 gap-0 rounded-3xl overflow-hidden shadow-2xl bg-white">
            ...
            <div class="p-8 sm:p-12 flex flex-col justify-center">
                <div class="mb-10">
                    ...
                    <h3 class="text-2xl font-bold text-on-surface mb-2">¡Bienvenido, Mentor!</h3>
                    <p class="text-on-surface-variant">Inicia sesión en tu cuenta para gestionar tus tutorías.</p>
                </div>
                ...
                <form action="{{ route('login.tutor') }}" method="POST" class="space-y-6" novalidate>
                    ...
                    <div x-data="{ showPassword: false }">
                        <div class="flex justify-between mb-2">
                            ...
                            <a href="{{ route('password.request') }}" class="text-sm font-bold text-teal-600 hover:text-teal-700 transition-colors">¿La olvidaste?</a>
                        </div>
                        <div class="relative">
                    ...
                    <div class="flex items-center">
                        <input id="remember-me" name="remember-me" type="checkbox" class="h-4 w-4 text-teal-600 focus:ring-teal-500 border-outline-variant rounded">
                ...
                <div class="mt-8 text-center">
                    <p class="text-on-surface-variant text-sm">
                        ...
                        <a href="{{ route('register.tutor') }}" class="font-bold text-teal-600 hover:text-teal-700 transition-colors">Regístrate como Mentor</a>
                    </p>
                </div>
            </div>
        </div>
