                ...
                <div class="relative z-10 text-white">
                    ...
                    <div>
                        <h2 class="text-4xl font-extrabold mb-6 leading-tight">
                            {{ __('messages.register_tutor_portal_headline') }}</h2>
                        <p class="text-lg text-white/90 mb-8 leading-relaxed">
                            {{ __('messages.register_tutor_portal_desc') }}
                        </p>
                    </div>
                    ...
                    <div class="space-y-6">
                        <div class="flex items-start space-x-4">
                            ...
                            <p class="font-medium">{{ __('messages.register_tutor_promo_1') }}</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="p-8 sm:p-12">
                <div class="mb-8">
                    <div
                        ...
                        <span>{{ __('messages.register_portal_tutor') }}</span>
                        <span>•</span>
                    ...
                    <h3 class="text-2xl font-bold text-on-surface mb-2">{{ __('messages.register_tutor_title') }}</h3>
                    <p class="text-on-surface-variant">{{ __('messages.register_tutor_desc') }}</p>
                </div>
                ...
                <form action="{{ route('register.tutor') }}" method="POST"
                    ...
                    <div class="col-span-2">
                        <label
                            class="block text-xs font-bold text-on-surface mb-2 tracking-widest uppercase text-teal-600">{{ __('messages.register_name') }}</label>
                    ...
                    <div class="col-span-2">
                        <label
                            class="block text-xs font-bold text-on-surface mb-2 tracking-widest uppercase text-teal-600">{{ __('messages.register_email') }}
                            (@unab.edu.co)</label>
                    ...
                    <div class="col-span-2 md:col-span-1">
                        <label
                            class="block text-xs font-bold text-on-surface mb-2 tracking-widest uppercase text-teal-600">{{ __('messages.register_program') }}</label>
                    ...
                    <div class="col-span-2 md:col-span-1" x-data="{ show: false }">
                        <label
                            class="block text-xs font-bold text-on-surface mb-2 tracking-widest uppercase text-teal-600">{{ __('messages.register_password') }}</label>
                        <div class="relative">
                    ...
                    <div class="col-span-2 md:col-span-1" x-data="{ show: false }">
                        <label
                            class="block text-xs font-bold text-on-surface mb-2 tracking-widest uppercase text-teal-600">{{ __('messages.register_confirm') }}</label>
                        <div class="relative">
                    ...
                    <div class="col-span-2">
                        <button type="submit"
                            ...
                            {{ __('messages.register_tutor_button') }}
                        </button>
                    </div>
                </form>
                ...
                <div class="mt-8 text-center">
                    <p class="text-on-surface-variant text-sm">
                        ...
                        <a href="{{ route('login.tutor') }}"
                            class="font-bold text-teal-600 hover:text-teal-700 transition-colors">{{ __('messages.register_login') }}</a>
                    </p>
                </div>
            </div>
        </div>
