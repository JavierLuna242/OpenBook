    ...
    <div class="py-16 bg-surface min-h-[80vh] flex items-center justify-center">
        <div class="max-w-4xl w-full mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12">
                <h1 class="text-4xl font-extrabold text-on-surface mb-4">{{ __('messages.register_choice_title') }}</h1>
                <p class="text-on-surface-variant text-lg">{{ __('messages.register_choice_desc') }}</p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <a href="{{ route('register.student') }}"
                    ...
                    <h2 class="text-2xl font-bold text-on-surface mb-3">{{ __('messages.register_card_student_title') }}
                    </h2>
                    <p class="text-on-surface-variant">{{ __('messages.register_card_student_desc') }}</p>
                </a>
                ...
                <a href="{{ route('register.tutor') }}"
                    ...
                    <h2 class="text-2xl font-bold text-on-surface mb-3">{{ __('messages.register_card_tutor_title') }}
                    </h2>
                    <p class="text-on-surface-variant">{{ __('messages.register_card_tutor_desc') }}</p>
                </a>
            </div>

            <div class="mt-12 text-center">
                <p class="text-on-surface-variant">
                    {{ __('messages.register_have_account') }} <a href="{{ route('login') }}"
                        class="text-primary font-bold hover:underline">{{ __('messages.register_login') }}</a>
                </p>
            </div>
        </div>
    </div>
